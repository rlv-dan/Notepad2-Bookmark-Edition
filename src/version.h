...
#define VERSION_FILEVERSION_SHORT    L"4.2.25"
	...
	#define VERSION_FILEVERSION_LONG    L"Notepad2 4.2.25 (Bookmark Edition R4)"
	#define VERSION_BOOKMARK_ED			L"Bookmark Edition by RL Vision"
	#define VERSION_BOOKMARK_ED_LINK    L"http://www.rlvision.com"
#else
